...
def read_csv(file_name, graph_key, sigma3, R_f, color, DATA):
    ...
    with open(file_name) as csvfile:
        ...
        DATA['graphs_initial'][graph_key]['sigma1_init'] = DATA['graphs_initial'][graph_key]['y'][0]
        DATA['graphs_initial'][graph_key]['epsilon_init'] = DATA['graphs_initial'][graph_key]['x'][0]
...
def cut_graph(graph_key, DATA, sigma1_init):
    ...
    if sigma1_init != 0 and DATA['graphs_initial'][graph_key]['sigma1_init'] != 0:
        cut_graph(graph_key, DATA, 0)
...
def redraw_graph(DATA, axes, figure):
    ...
    for graph_key in DATA['graphs_created']:
        axes.plot(
            ...
            color=DATA['graphs_created'][graph_key]['color'],
            linestyle='--'
        )
        axes.plot(
        ...
        if DATA['graphs_created'][graph_key]['checkbox_E50']:
            E50 = DATA['graphs_created'][graph_key]['E50']
            sigma = 100
            epsilon = sigma / E50
            axes.axline(
                (0, 0),
